...
public class PurchasesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView=inflater.inflate(R.layout.add_purchase_layout,container,false);

        name=(MaterialEditText)rootView.findViewById(R.id.add_purchase_name);
        description=(MaterialEditText)rootView.findViewById(R.id.add_purchase_description);
        quantity=(MaterialEditText)rootView.findViewById(R.id.add_purchase_quantity);
        amount=(MaterialEditText)rootView.findViewById(R.id.add_purchase_amount);
