 ...
 */
public class CurrentAssetsRowLayoutOneAdapter extends BaseAdapter {
    Context context;
    List<?> items;
    ArrayList<CurrentAssets> listItems;

    public CurrentAssetsRowLayoutOneAdapter(Context context,List<?> items){
        this.context=context;
        this.items=items;
        listItems=(ArrayList<CurrentAssets>)items;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        description.setText(""+listItems.get(position).getWorth());
