 ...
 */
public class NonCurrentAssetsRowLayoutOneAdapter extends BaseAdapter {
    Context context;
    List<?> items;
    ArrayList<NonCurrentAssets> listItems;

    public NonCurrentAssetsRowLayoutOneAdapter(Context context,List<?> items){
        this.context=context;
        this.items=items;
        listItems=(ArrayList<NonCurrentAssets>)items;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        description.setText(listItems.get(position).getCost()+"");
