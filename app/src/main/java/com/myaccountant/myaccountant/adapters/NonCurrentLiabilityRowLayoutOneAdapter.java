 ...
 */
public class NonCurrentLiabilityRowLayoutOneAdapter extends BaseAdapter {
    Context context;
    List<?> items;
    ArrayList<NonCurrentLiabilities> listItems;

    public NonCurrentLiabilityRowLayoutOneAdapter(Context context,List<?> items){
        this.context=context;
        this.items=items;
        listItems=(ArrayList<NonCurrentLiabilities>)items;
    }
