 ...
 */
public class RowLayoutTwoAdapter extends BaseAdapter {

    Context context;
    List<?> items;
    ArrayList<Sales> salesList;

    public RowLayoutTwoAdapter(Context context,List<?> items){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        image.setImageDrawable(getDrawable(salesList.get(position).getName().substring(0)));
